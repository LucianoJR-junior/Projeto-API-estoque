...
@RestControllerAdvice // avisa ao sptring que estga classe vigia os erros da API
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> tratarEttosValidacao(MethodArgumentNotValidException ex) {
