...
public interface ProdutosRepository extends JpaRepository<Produtos, Long> {
    ...
    // Combina o filtro por categoria com a busca por nome
    List<Produtos> findByCategoriaIdAndNomeContainingIgnoreCase(Long categoriaId, String nome);

    // Usado para impedir a exclusão de uma categoria que ainda possui produtos
